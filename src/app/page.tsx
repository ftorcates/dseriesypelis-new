...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className="section shell home-agenda-more" data-motion-reveal>
        ...
        <div className="episode-rail" data-motion-stagger>
          {episodes.map((event) => (
      ...
      <section className="section section-tinted home-ranking" data-motion-reveal>
        <div className="shell">
          ...
          <div className="media-grid ranking-preview" data-motion-stagger>
            {ranking.map((item, index) => <MediaCard item={item} rank={index + 1} key={item.id} />)}
          </div>
        </div>
      </section>

      <section className="section shell split-feature" data-motion-reveal data-motion-stagger>
        <div className="movie-radar-copy" data-motion-item>
        ...
        <div className="movie-fan" data-motion-item>
      ...
      <section className="shell editorial-banner" data-motion-reveal>
      ...
      <HomeMotion recommendationScore={featured.score} />
    </>
  );
}
